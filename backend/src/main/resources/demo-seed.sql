...
--   * kilkadziesiąt konfliktów zasobowych — gotowy materiał dla optymalizatora
...
--
-- Horyzont scenariusza: 2026-04-20 → 2026-06-15 (57 dni kalendarzowych).
...
(VALUES
  (1,  'Audyt UX obecnej strony sklepu',
       ...
       'DONE',         'MEDIUM',  '2026-04-20', '2026-04-22', 100,
  ...
  (2,  'Research konkurencji i trendów e-commerce 2026',
       ...
       'DONE',         'LOW',     '2026-04-23', '2026-04-25', 100,
  ...
  (3,  'Wireframes głównych widoków',
       ...
       'IN_PROGRESS',  'HIGH',    '2026-05-04', '2026-05-07', 50,
  ...
  (4,  'Projekt graficzny strony głównej',
       ...
       'BACKLOG',      'HIGH',    '2026-05-11', '2026-05-14', 0,
  ...
  (5,  'Projekt graficzny listy i karty produktu',
       ...
       'BACKLOG',      'MEDIUM',  '2026-05-15', '2026-05-18', 0,
       'marta.wisniewska@flowlink.pl',     'design'),
  (6,  'Migracja treści z obecnego CMS',
       ...
       'IN_PROGRESS',  'LOW',     '2026-05-04', '2026-05-07', 40,
  ...
  (7,  'Implementacja komponentów UI w React',
       ...
       'BACKLOG',      'MEDIUM',  '2026-05-22', '2026-05-26', 0,
  ...
  (8,  'Nowy koszyk zakupowy z mini-widokiem',
       ...
       'BACKLOG',      'HIGHEST', '2026-05-18', '2026-05-21', 0,
  ...
  (9,  'Integracja bramki płatności Stripe',
       ...
       'BACKLOG',      'HIGH',    '2026-05-22', '2026-05-25', 0,
  ...
  (10, 'Odświeżenie strony kontaktu',
       ...
       'BACKLOG',      'LOWEST',  '2026-06-07', '2026-06-09', 0,
  ...
  (11, 'Nowy formularz zapisu na newsletter',
       ...
       'BACKLOG',      'LOW',     '2026-05-23', '2026-05-24', 0,
  ...
  (12, 'Optymalizacja SEO (meta, sitemap, schema.org)',
       ...
       'BACKLOG',      'MEDIUM',  '2026-05-27', '2026-05-29', 0,
  ...
  (13, 'Testy A/B nowej strategii cenowej',
       ...
       'BACKLOG',      'MEDIUM',  '2026-06-11', '2026-06-13', 0,
  ...
  (14, 'Wdrożenie na środowisko staging',
       ...
       'BACKLOG',      'MEDIUM',  '2026-06-02', '2026-06-04', 0,
  ...
  (15, 'Release produkcyjny wersji 2.0',
       ...
       'BACKLOG',      'HIGHEST', '2026-06-14', '2026-06-15', 0,
...
(VALUES
  ...
  (2,  'Projekt architektury aplikacji',
       ...
       'IN_PROGRESS',  'HIGH',    '2026-04-27', '2026-05-01', 70,
  ...
  (3,  'Konfiguracja CI/CD z Fastlane',
       ...
       'BACKLOG',      'MEDIUM',  '2026-05-26', '2026-05-28', 0,
  ...
  (4,  'Implementacja logowania biometrycznego',
       ...
       'BACKLOG',      'HIGHEST', '2026-05-11', '2026-05-13', 0,
  ...
  (5,  'Ekran logowania i rejestracji',
       ...
       'BACKLOG',      'MEDIUM',  '2026-05-19', '2026-05-22', 0,
  ...
  (6,  'Ekran listy produktów z infinite scroll',
       ...
       'BACKLOG',      'HIGH',    '2026-05-28', '2026-05-31', 0,
       'marta.wisniewska@flowlink.pl',     'mobile,frontend'),
  (7,  'Ekran szczegółów produktu',
       ...
       'BACKLOG',      'MEDIUM',  '2026-05-29', '2026-05-31', 0,
  ...
  (8,  'Koszyk mobilny z checkoutem',
       ...
       'BACKLOG',      'HIGHEST', '2026-06-01', '2026-06-04', 0,
  ...
  (9,  'Push notyfikacje (FCM + APNS)',
       ...
       'BACKLOG',      'MEDIUM',  '2026-05-30', '2026-06-01', 0,
  ...
  (10, 'Tryb offline z lokalnym cache',
       ...
       'BACKLOG',      'MEDIUM',  '2026-06-01', '2026-06-03', 0,
  ...
  (11, 'Lokalizacja aplikacji (PL/EN)',
       ...
       'BACKLOG',      'LOW',     '2026-06-06', '2026-06-07', 0,
  ...
  (12, 'Onboarding pierwszego użytkownika',
       ...
       'BACKLOG',      'LOW',     '2026-05-23', '2026-05-25', 0,
  ...
  (13, 'Skanowanie kodu kreskowego (barcode)',
       ...
       'BACKLOG',      'LOWEST',  '2026-06-06', '2026-06-07', 0,
  ...
  (14, 'Testy QA na różnych urządzeniach',
       ...
       'BACKLOG',      'LOW',     '2026-06-03', '2026-06-04', 0,
  ...
  (15, 'Publikacja w App Store i Google Play',
       ...
       'BACKLOG',      'HIGH',    '2026-06-05', '2026-06-07', 0,
...
(VALUES
  (1,  'Analiza wymagań biznesowych partnerów hurtowych',
       ...
       'DONE',         'LOW',     '2026-04-27', '2026-04-29', 100,
  ...
  (2,  'Wybór stacku technologicznego',
       ...
       'DONE',         'MEDIUM',  '2026-04-23', '2026-04-25', 100,
  ...
  (3,  'Model danych i schemat bazy',
       ...
       'IN_PROGRESS',  'MEDIUM',  '2026-04-30', '2026-05-02', 60,
  ...
  (5,  'Endpointy CRUD produktów (REST)',
       ...
       'BACKLOG',      'HIGH',    '2026-05-04', '2026-05-07', 0,
  ...
  (7,  'Webhooks notyfikacji zdarzeń',
       ...
       'BACKLOG',      'MEDIUM',  '2026-06-04', '2026-06-06', 0,
  ...
  (8,  'Rate limiting i throttling',
       ...
       'BACKLOG',      'MEDIUM',  '2026-05-24', '2026-05-26', 0,
  ...
  (9,  'Dokumentacja OpenAPI 3.0 (Swagger)',
       ...
       'BACKLOG',      'LOW',     '2026-05-24', '2026-05-26', 0,
  ...
  (10, 'Monitoring (Prometheus + Grafana)',
       ...
       'BACKLOG',      'MEDIUM',  '2026-06-05', '2026-06-07', 0,
  ...
  (11, 'Testy obciążeniowe (JMeter)',
       ...
       'BACKLOG',      'MEDIUM',  '2026-06-08', '2026-06-10', 0,
  ...
  (12, 'Panel administracyjny partnerów',
       ...
       'BACKLOG',      'LOW',     '2026-05-25', '2026-05-27', 0,
  ...
  (13, 'Eksport danych do CSV',
       ...
       'BACKLOG',      'LOWEST',  '2026-06-07', '2026-06-08', 0,
  ...
  (14, 'Eksport do XML (standard EDI)',
       ...
       'BACKLOG',      'LOWEST',  '2026-06-08', '2026-06-09', 0,
  ...
  (15, 'Publikacja API v1.0',
       ...
       'BACKLOG',      'HIGH',    '2026-06-11', '2026-06-13', 0,
